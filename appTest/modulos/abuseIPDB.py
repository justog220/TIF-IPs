...
class AbuseIPDB:
    ...
    def getInfo(self, ip):
        ...
        keys = ['esPublica', 'estaEnWhitelist', 'scoreAbuso', 'codigoPais', 'isp', 'tipoDeUso', 'ultimoReporte']
        keysOr = ['isPublic', 'isWhitelisted', 'abuseConfidenceScore', 'countryCode', 'isp', 'usageType', 'lastReportedAt']
